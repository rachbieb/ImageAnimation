...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](./demo.ipynb) [![Open in Kaggle](https://kaggle.com/static/images/open-in-kaggle.svg)](./demo.ipynb)

@graphemecluster prepared a GUI demo for the Google Colab. It also works in Kaggle. For the source code, see [```demo.ipynb```](./demo.ipynb).

For the old demo, see [```old_demo.ipynb```](./old_demo.ipynb).
...
5) **Nemo**. Please follow the [instructions](https://www.uva-nemo.org/) on how to download the dataset.
